...
public class VisionProcessingOpenCV extends Subsystem {
...
//The following code is adjusted code from 4915 Stronghold
package org.usfirst.frc.team5401.robot.subsystems;
...
public class VisionProcessingOpenCV implements NamedSendable {

    private static VisionProcessingOpenCV s_instance;

    public synchronized static VisionProcessingOpenCV getInstance() {
        if (s_instance == null)
            s_instance = new VisionProcessingOpenCV();
        return s_instance;
    }
    ...
    private VisionProcessingOpenCV() {
    }
...
//        RobotMap.PHOTONIC_CANNON.set(on);//Photonic Cannon was the DigitalOutput, placed in DIO
    }
}
